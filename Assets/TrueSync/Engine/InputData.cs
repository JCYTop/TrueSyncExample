    ...
    public class InputData : InputDataBase
    {
        ...
        **/
        ...
        public int Count
        {
            get
            {
                return (this.stringTable.Count + this.byteTable.Count + this.intTable.Count + this.fpTable.Count + this.byteArrayTable.Count + this.tsVectorTable.Count +
                        this.tsVectorTable2.Count);
            }
        }
